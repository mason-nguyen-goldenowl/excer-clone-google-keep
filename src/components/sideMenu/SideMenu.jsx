  ...
  return (
    <div className="sideMenu">
      <ul className={`listItem ${listClass}`}>
        <li className="listItem__item" id="notes">
          <div className="item__content">
            <svg
        ...
        <li className="listItem__item " id="reminders">
          <div className="item__content">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <li className="listItem__item " id="archive">
          <Link to="/archive">
            <div className="item__content">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <li className="listItem__item " id="trash">
          <Link to="/trash">
            <div className="item__content">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                viewBox="0 0 24 24"
              >
                <path d="M15 4V3H9v1H4v2h1v13c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6h1V4h-5zm2 15H7V6h10v13z M9 8h2v9H9zm4 0h2v9h-2z"></path>
              </svg>
              <span>Trash</span>
            </div>
          </Link>
